...
from timm_local import *
# new timm imports >= 0.8.1
from timm_local.layers import RotAttentionPool2d
from timm_local.layers import AttentionPool2d as AbsAttentionPool2d
from timm_local.layers import Mlp, to_2tuple
