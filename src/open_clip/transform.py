...
class PreprocessCfg:
    ...
    mode: str = 'RGB'
    mean_ori: Tuple[float, ...] = OPENAI_DATASET_MEAN
    std_ori: Tuple[float, ...] = OPENAI_DATASET_STD
    mean: Tuple[float, ...] = INCEPTION_MEAN
    std: Tuple[float, ...] = INCEPTION_STD
