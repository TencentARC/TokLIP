...
from timm_local.layers import Conv2dSame, ScaledStdConv2dSame, CondConv2d, StdConv2dSame, Format
from timm_local.layers import resample_abs_pos_embed, resample_abs_pos_embed_nhwc
from timm_local.layers.non_local_attn import BilinearAttnTransform
from timm_local.layers.pool2d_same import MaxPool2dSame, AvgPool2dSame
from timm_local.layers.norm_act import (
    BatchNormAct2d,
    SyncBatchNormAct,
...
# NOTE: By default, any modules from timm_local.models.layers that we want to treat as leaf modules go here
# BUT modules from timm_local.models should use the registration mechanism below
_leaf_modules = {
...
try:
    from timm_local.layers import InplaceAbn
