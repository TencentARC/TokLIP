...
"""
Modified from timm_local. https://github.com/rwightman/pytorch-image-models/blob/master/timm/models/vision_transformer.py
...
from timm_local.layers import DropPath, to_2tuple, trunc_normal_, _assert
