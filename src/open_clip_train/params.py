...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="Lock image tower by disabling gradients.",
    )
    parser.add_argument(
    ...
    # NOTE Add more arguments here.
    parser.add_argument(
        "--init-visual-weights",
        default=False,
        action="store_true",
        help='init visual part.'
    )
    parser.add_argument(
        "--lock-logit-scale",
        default=False,
        action="store_true",
        help='lock logit scale.'
    )
    parser.add_argument(
        "--lock-text-embed",
        default=False,
        action="store_true",
        help='lock text embed.'
    )
    parser.add_argument(
        "--init-logit-scale",
        default=False,
        action="store_true",
        help='init logit scale.'
    )
    parser.add_argument(
        "--high-resolution",
        default=False,
        action="store_true",
        help='inference for high resolution.'
    )
    parser.add_argument(
        "--soft-mask",
        default=False,
        action="store_true",
        help='soft mask for causal attention.'
    )
    parser.add_argument(
        "--soft-mask-epochs",
        default=0,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help='save in epoch training.'
    )
    parser.add_argument(
        "--coco-retrieval",
        default=False,
        action="store_true",
        help='retrieval mscoco.'
    )
    parser.add_argument(
        "--filter-low-resolution",
        default=False,
        action="store_true",
        help='filter low resolution images for training.'
    )
    parser.add_argument(
        "--coco-dir",
        type=str,
        default='/coco/coco/val2014',
