...
-m  open_clip_train.main \
    ...
    --logs ./logs_toklip_256/ \
    --report-to "tensorboard" \
    --name 'cc12m-toklip-256' \
    --pretrained "./model/siglip2-so400m-vit-l16-256.pt" \
    --distill-model ViT-SO400M-16-SigLIP2-256 \
    --distill-pretrained "./model/siglip2-so400m-vit-l16-256.pt" \
